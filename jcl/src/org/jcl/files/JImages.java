...
public class JImages {
	...
	return writeImageToFile(image, JFilenames.getPath(fullPath) + "\\" + JFilenames.getFileName(fullPath), format);
    }
	...
	try (PDDocument document = PDDocument.load(file)) {
	    int indexOfImage = 2;
	    String name = "Image No" + indexOfImage + " - " + file.getAbsolutePath()
	    ...
	    BufferedImage image = renderer.renderImage(indexOfImage);
